...
let tokenUpgrades = {
    ...
    double: {
        money: {
            ...
            effectPrecision: 0,
            costAmount: (x) => D.pow(3, x).mul(5),
        },
        gems: {
            effectAmount: (x) => D.pow(2, x),
            effectText: ["×{0}", "all Gems gains"],
            effectPrecision: 0,
            costAmount: (x) => D.pow(5, x).mul(2),
        },
        scrap: {
            effectAmount: (x) => D.pow(2, x),
            effectText: ["×{0}", "all Glyph gains"],
            effectPrecision: 0,
            costAmount: (x) => D.pow(8, x).mul(5),
        },
        charge: {
            requires: ["atm1"],
            effectAmount: (x) => D.pow(2, x),
    ...
    runeEff: {
        ...
        charge: {
            ...
            effectPrecision: 0,
            maxAmount: 15,
            costAmount: (x) => D.pow(2.5, x).mul(2),
        },
    },
}
